...
SUDO_USERS = [5840594311,1003575883]

AUTH_CHANNEL = -1002663510614
...
@bot.on_message(filters.command(["tushar","upload"]))
async def upload(bot: Client, m: Message):
    ...
    await m.reply_text(f"<pre><code>『😏𝗥𝗲𝗮𝗰𝘁𝗶𝗼𝗻 𝗞𝗼𝗻 𝗗𝗲𝗴𝗮😏』</code></pre>\n\n𝗥𝗲𝗮𝗰𝘁𝗶𝗼𝗻 𝗗𝗲 𝗗𝗶𝘆𝗮 𝗞𝗮𝗿𝗼 𝗧𝗮𝗸𝗶 𝗛𝗮𝗺𝗲 𝗕𝗵𝗶 𝗟𝗲𝗰𝘁𝘂𝗿𝗲 𝗨𝗽𝗹𝗼𝗮𝗱 𝗞𝗮𝗿𝗻𝗲 𝗠𝗲 𝗠𝗮𝗷𝗮 𝗔𝗮𝘆𝗲🤩😌")                 
